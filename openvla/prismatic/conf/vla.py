...
@dataclass
class Exp_FreezeVIT_DinoSigLIP_224px_Bridge(Exp_SigLIP_224px_Bridge):
    vla_id: str = "dinosiglip-224px-icy+mx-bridge"
...
class Exp_DinoSigLIP_224px_OXE_Magic_Soup_Plus(Exp_SigLIP_224px_Bridge):
    ...
    base_vlm: Union[str, Path] = "prism-dinosiglip-224px+7b"
    # base_vlm: Union[str, Path] = "prism-dinosiglip-224px+8b"
    ...
    # data_mix: str = "resized71"
    # data_mix: str = "robo_set"
    # freeze_vision_backbone: bool = False
...
@dataclass
class DEBUG(Exp_SigLIP_224px_Bridge):
    vla_id: str = "debug"
    base_vlm: Union[str, Path] = "prism-dinosiglip-224px+7b"
    # base_vlm: Union[str, Path] = "prism-dinosiglip-224px+8b"
...
# === [8 GPU] SigLIP 224px + FrankaWipe ===
@dataclass
class Exp_SigLIP_224px_Calvin_Wipe(Exp_SigLIP_224px_Bridge):
    vla_id: str = "siglip-224px+mx-Calvin_wipe"
    base_vlm: Union[str, Path] = "siglip-224px+7b"

    data_mix: str = "Calvin_wipe"
...
class VLARegistry(Enum):
    ...
    Exp_FreezeVIT_DinoSigLIP_224px_Bridge = Exp_FreezeVIT_DinoSigLIP_224px_Bridge
    ...
    SIGLIP_224PX_MX_Calvin_WIPE = Exp_SigLIP_224px_Calvin_Wipe
