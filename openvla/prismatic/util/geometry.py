...
def from_pd_joint_pos_to_ee(
    ...
    for t in range(n):
        ...
        for _ in range(2):
            ...
            target_ee_poses.append(target_ee_pose)
            prev_ee_poses.append(prev_ee_pose_at_base)
            ee_poses.append(ee_pose_at_ee)

            # print(t, " target_ee_pose", target_ee_pose)
            # print(t, " prev_ee_pose_at_base", prev_ee_pose_at_base)
            # print(t, " ee_pose_at_ee", ee_pose_at_ee)
            # print(t, " arm_action", arm_action)
            # print(t, " output_action", output_action)
            # print("===============================")
    ...
    return info, output_actions, target_ee_poses, prev_ee_poses, ee_poses
    ...
    for ind in inds:
        ...
        for _ in range(args.max_retry + 1):
            ...
            # From joint position to others
                ...
                info, _, _, _, _ = from_pd_joint_pos(
                    target_control_mode,
                    ori_actions,
                    ori_env,
                    env,
            ...
            # From joint delta position to others
                ...
                info, _ = from_pd_joint_delta_pos(
                    target_control_mode,
                    ori_actions,
                    ori_env,
                    env,
