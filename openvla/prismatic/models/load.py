...
def load_vla(
    ...
    # config_json = '/xxx/xxx/Anonymous/Code/embodied_foundation/openvla/config.json'
    with open(config_json, "r") as f:
    ...
    # import torch
    # llm_backbone.llm.model.layers=torch.nn.ModuleList(llm_backbone.llm.model.layers[:12])
