...
Notes & Prerequisites:
    ...
    - If you want to set a custom location for all HF / TIMM artifacts --> `export HF_HOME="<PATH>"` *before* running!
        => For example (add to end of .bashrc): `export HF_HOME="/xxx/fsx/skaramcheti/cache"`
...
class PretrainConfig:
    ...
    run_root_dir: Path = Path("/xxx/fsx/x-prismatic-vlms/runs")     # Path to directory to store logs & checkpoints
